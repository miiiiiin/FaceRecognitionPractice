...
for image in images:
    try:
        ...
        #     "src")
        imgUrl = driver.find_element(By.XPATH, '//*[@id="Sva75c"]/div[2]/div[2]/div[2]/div[2]/c-wiz/div/div/div/div/div[3]/div[1]/a/img').get_attribute("src")
        # imgUrl = driver.find_element_by_css_selector(".sFlh5c.pT0Scc.iPVvYb")#.get_attribute("src")
